    ...
    public class ViewData: ViewModelBase, IDataErrorInfo
    {
        ...
        public void SaveHandler(object sender)
        {
            try
            {
                ...
                string FilePath = "C:\\Users\\ruslan\\Desktop\\task1_GenAlg_C#\\401_kasumov-master\\lab2\\lab3\\hello.db";
                string ExperName = Interaction.InputBox("Введите имя эксперимента", "");
                Alg.SaveStatement(FilePath, ExperName);
            }
            catch (Exception ex)
            {
        ...
        public void LoadHandler(object sender)
        {
            try
            {
                ...
                string ExperName = Interaction.InputBox("Введите имя эксперимента", "");
                Alg = new GenAlg(FilePath, ExperName);
